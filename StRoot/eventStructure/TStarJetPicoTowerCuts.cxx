...
Bool_t TStarJetPicoTowerCuts::IsTowerOK(Int_t mTowId, Int_t mTrigId)
{
  ...
  else if ( mTrigId==350502 || mTrigId==350512 || mTrigId==350503 || mTrigId==350513 || mTrigId==350504 || mTrigId==350514 || mTrigId==350003 || mTrigId==350013 || mTrigId==350023 || mTrigId==350033 || mTrigId==350043 ) {

      if( mTowId==31 || mTowId==293 || mTowId==395 || mTowId==509 || mTowId==671 || mTowId==993 || mTowId==1063 || mTowId==1232 || mTowId==1237 || mTowId==1241 || mTowId==1284 || mTowId==1306 || mTowId==1313 || mTowId==1375 || mTowId==1387 || mTowId==1440 || mTowId==1838 || mTowId==1945 || mTowId==2162 || mTowId==2214 || mTowId==2310 || mTowId==2445 || mTowId==3407 || mTowId==3861 ) 
