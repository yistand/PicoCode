...
class TStMuCutEventJet : public TObject
{
 ...
 public:
  ...
  void      Reset();
  void      SetStandardCutsCuCuMinBias();
  void      SetStandardCutsCuCuHighTwr();
  void      SetStandardCutsCuCu62MinBias();
  void      SetStandardCutsAuAuCentral();
  void      SetStandardCutsAuAuMinBias();
  void      SetStandardCutsAuAuL2();
  void      SetStandardCutsAuAuY7Min();
  void      SetStandardCutsAuAu62();
  void      SetStandardCutsAuAu19();
  void      SetStandardCutsAuAuMBHalfHL04();
  void      SetStandardCutsAuAu39();

  void      SetStandardCutsPPMinBiasY6();
  void      SetStandardCutsPPHTTPY6();
  void      SetStandardCutsPPHT2Y6();
  void      SetStandardCutsPPJP1mbY6();
  void      SetStandardCutsPPallY6();

  void      SetStandardCutsdAuALLY8();
  void      SetStandardCutsdAuHTY8();

  void      SetStandardCutsMC();
...
//#ly  void      PrintCutList();
 ...
 protected:
  ...
  ClassDef(TStMuCutEventJet,1)                    //  Event cuts
